# Compare sparkMeasure with sparklens

## References:

* [Official sparkMeasure:](https://github.com/LucaCanali/sparkMeasure)
* [Official sparklens:](https://github.com/qubole/sparklens)

## Built jars:
   - [sparkMeasure](https://github.com/alitet01/etc/blob/master/spark/metrics/spark-measure_2.11-0.12-SNAPSHOT.jar)
   - [sparklens](https://github.com/alitet01/etc/blob/master/spark/metrics/sparklens_2.11-0.1.2.jar)
